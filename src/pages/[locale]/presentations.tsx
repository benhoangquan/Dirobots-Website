...
const PresentationsPage = () => {
    ...
    useEffect(() => {
        if (!selectedPdf && semesters.length > 0 && semesters[0].presentations.length > 0) {
    ...
    return (
        <div className="min-h-screen bg-cream flex flex-col">
            <Head>
                ...
                <meta name="description" content="Dirobots Club Presentations and Lectures" />
            </Head>
                                    ...
                                    {semester.presentations.map((presentation) => (
                                        <li key={presentation.id}>
                                            ...
                                            >
                                                ...
                                                <div className={`text-sm ${selectedPdf === presentation.pdfUrl ? 'text-white/80' : 'text-gray-500'}`}>
                                                    {presentation.date}
                                                </div>
                                            </button>
                                        </li>
