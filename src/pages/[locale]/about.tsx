...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>About Us | Dirobots</title>
        <meta
          name="description"
          content="Learn about Dirobots, the Robotics club at University of Montreal"
        />
      </Head>
